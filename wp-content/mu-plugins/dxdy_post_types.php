...
function dxdy_custom_post_types() {
  ...
  //     'all_items' => __( 'All Content Page' ),
  //     'add_new' => __( 'Add Content Page' ),
  //     'add_new_item' => __( 'Add New Content Page' ),
  //     'edit' => __( 'Edit' ),
  //     'edit_item' => __( 'Edit Content Page' ),
  //     'new_item' => __( 'New Content Page' ),
  //     'view_item' => __( 'View Content Page' ),
  //     'search_items' => __( 'Search Content Page' ),
  //   ],
  //   'description' => __( "Content pages" ),
  //   'public' => true,
